...
**Endpoint:** `GET https://app-cbcy2gncy0ox-api-wL1zlEdVM6DY.gateway.appmedo.com/v1/news/top`
...
async function getTopStories(params: TopStoriesParams = {}): Promise<TopStoriesResponse> {
  ...
  const response = await fetch(
    `https://app-cbcy2gncy0ox-api-wL1zlEdVM6DY.gateway.appmedo.com/v1/news/top${qs ? `?${qs}` : ""}`,
    {
      method: "GET",
      headers: {
