...
| Property | Value |
|----------|-------|
| Submit Endpoint | `POST https://app-cbcy2gncy0ox-api-qYGWo8XA7JVY.gateway.appmedo.com/v1/videos/text2video` |
| Query Endpoint | `GET https://app-cbcy2gncy0ox-api-oLpZ7eD5j2Pa.gateway.appmedo.com/v1/videos/text2video/{id}` |
