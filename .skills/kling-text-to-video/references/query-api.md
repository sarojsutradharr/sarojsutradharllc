...
| Property | Value |
|----------|-------|
| Endpoint | `GET https://app-cbcy2gncy0ox-api-oLpZ7eD5j2Pa.gateway.appmedo.com/v1/videos/text2video/{id}` |
| HTTP Method | `GET` |
...
async function queryTask(taskId: string): Promise<QueryTaskResult> {
  const response = await fetch(
    `https://app-cbcy2gncy0ox-api-oLpZ7eD5j2Pa.gateway.appmedo.com/v1/videos/text2video/${encodeURIComponent(taskId)}`,
    {
      method: "GET",
      headers: {
