...
| Property | Value |
|----------|-------|
| Endpoint | `POST https://app-cbcy2gncy0ox-api-qYGWo8XA7JVY.gateway.appmedo.com/v1/videos/text2video` |
| HTTP Method | `POST` |
...
async function submitTextToVideo(
  ...
  const response = await fetch(
    "https://app-cbcy2gncy0ox-api-qYGWo8XA7JVY.gateway.appmedo.com/v1/videos/text2video",
    {
      method: "POST",
      headers: {
