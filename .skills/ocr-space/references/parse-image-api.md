...
| Property | Value |
|----------|-------|
| Endpoint | `POST https://app-cbcy2gncy0ox-api-W9z3M6eONl3L.gateway.appmedo.com/parse/image` |
...
async function ocrParseImage(params: {
  ...
  const response = await fetch("https://app-cbcy2gncy0ox-api-W9z3M6eONl3L.gateway.appmedo.com/parse/image", {
    method: "POST",
    headers: {
...
serve(async (req: Request): Promise<Response> => {
  ...
  // --- Call upstream ---
  const upstream = await fetch("https://app-cbcy2gncy0ox-api-W9z3M6eONl3L.gateway.appmedo.com/parse/image", {
    method: "POST",
    headers: {
