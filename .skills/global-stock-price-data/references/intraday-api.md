...
**Endpoint:** `GET https://app-cbcy2gncy0ox-api-pLVzJ8y7V3KL.gateway.appmedo.com/v1/data/intraday`
...
async function getIntradayData(symbol: string, params: IntradayParams = {}): Promise<IntradayResponse> {
  ...
  const response = await fetch(
    `https://app-cbcy2gncy0ox-api-pLVzJ8y7V3KL.gateway.appmedo.com/v1/data/intraday?${query.toString()}`,
