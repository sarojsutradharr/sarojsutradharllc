...
**Endpoint:** `GET https://app-cbcy2gncy0ox-api-oYA6Z8wDBN1a.gateway.appmedo.com/v1/data/quote`
...
async function getStockPrices(
  ...
  const response = await fetch(
    `https://app-cbcy2gncy0ox-api-oYA6Z8wDBN1a.gateway.appmedo.com/v1/data/quote?${query.toString()}`,
