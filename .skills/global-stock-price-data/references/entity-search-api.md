...
**Endpoint:** `GET https://app-cbcy2gncy0ox-api-Xa6JZq205MNa.gateway.appmedo.com/v1/entity/search`
...
async function searchEntities(params: EntitySearchParams = {}): Promise<EntitySearchResponse> {
  ...
  const response = await fetch(
    `https://app-cbcy2gncy0ox-api-Xa6JZq205MNa.gateway.appmedo.com/v1/entity/search?${query.toString()}`,
